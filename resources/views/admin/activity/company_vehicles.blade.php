...
<div class="bg-white border rounded mb-4">
    <div class="">
        ...
        <div class="px-4 py-3 d-flex align-items-center">
            <h4 class="font-weight-600 mb-0">All Records</h4>
        ...
        <table class="table">
            ...
            <tr>
                <td><a href="{{ route('admin.vehicles.single', $activity->by->id) }}">{{ $activity->by->registration_no.' ('.$activity->by->description.')' }}</a></td>
